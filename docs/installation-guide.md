...
2. `dist/study-timer-review-mockexam-web-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md` を取得する。
3. repo を clone する。

```powershell
git clone https://github.com/Sunmax0731/study-timer-review-mockexam-web.git
cd study-timer-review-mockexam-web
